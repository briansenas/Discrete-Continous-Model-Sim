...
pescar = "250 359 500 750 838 1000 1100 1150 1200 1250"
cada = "2 3 4 5 7 10"
set print "-"
do for [r in "5"]{
    do for[p in pescar]{
        do for[c in cada]{
            name="pescar-".r."-".c."-".p
                ...
                if (file_exists(filename)) {
                    out_N = dir."/"."pescado".r."-".c."-".p
                    outname = out_N.".png"
                    name = "Proyección de pescar ".p." cada ".c." con F=".r
                    set title name
                    set output outname
                    ...
                    unset y2label
                    unset y2tics
                    set title "Convergencia del Sistema al pescar ".p." cada ".c." días"
                    set ylabel "Peces grandes"
                    set xlabel "Peces pequeños"
